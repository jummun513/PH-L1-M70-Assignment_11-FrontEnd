                    ...
                    <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                        <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                            <div className="flex flex-col items-center">
                                ...
                                {
                                    ((from === 'register') && <h3 className="md:my-5 lg:my-8 my-3 text-xs md:text-sm leading-6 text-gray-900" id="modal-title">A email was send to you. Check Your Email Inbox or Spam. This will take 2-3 minutes.</h3>) ||
                        ...
                        <div className="bg-gray-50 px-4 py-3 flex justify-center sm:px-6">
                            {
                                ...
                                ||
                                ((from === 'register') && <button onClick={() => { componentWillUnmount(); okAction('/home') }} type="button" className="inline-flex w-full justify-center rounded-md bg-primary hover:bg-secondary px-3 py-2 lg:px-10 lg:py-3 text-sm lg:text-base font-semibold text-white shadow-sm sm:ml-3 sm:w-auto">Ok</button>)
                            }
                        </div>
                    </div>
                </div>
