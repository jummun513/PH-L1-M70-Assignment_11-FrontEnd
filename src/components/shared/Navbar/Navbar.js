        ...
        <div className='absolute z-10 px-2 md:px-0 w-full'>
            <div className="bg-transparent hidden xl:max-w-screen-xl xxl:max-w-screen-xxl mx-auto xl:flex items-center justify-between py-5">
                ...
                <div className="flex mb-2 md:mb-0 space-x-4 md:space-x-6 md:justify-start justify-center">
                    <a href="/" className="text-gray-100 hover:text-[#88C123]">
            ...
            <nav className="bg-transparent xxl:mt-3 md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl xxl:max-w-screen-xxl pt-4 xl:pt-0 flex flex-wrap items-center justify-between mx-auto">
                ...
                <div className="flex items-center md:order-2">
                    <button type="button" className="btn-style mr-2 sm:mr-3 md:mr-0 border-2 border-[#88C123] bg-[#88C123] text-white hover:bg-transparent">Sign In</button>
                    ...
                    <ul className="flex flex-col md:text-white rounded md:rounded-none mt-3 md:mt-0 text-center md:flex-row md:space-x-6 bg-white md:bg-transparent lg:space-x-12">
                        {navigation.map((item) => (
                            <li id='sidebar' key={item.name}>
                                <NavLink to={item.href} className=" text-sm font-semibold rounded flex justify-center py-3 md:px-3 md:py-2 hover:bg-[#88C123] hover:text-white md:hover:bg-[#88C123] ease-linear duration-150">
                                    {item.name}
                                </NavLink>
                            </li>
                        ))}
