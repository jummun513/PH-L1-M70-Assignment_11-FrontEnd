                ...
                <footer className="px-2 xsm:px-0 mx-auto xxl:max-w-screen-xxl xl:max-w-screen-xl lg:max-w-screen-lg md:max-w-screen-md sm:max-w-screen-sm xsm:max-w-screen-xsm">
                    <div className="md:flex justify-between">
                        <div className="md:w-1/2">
                            <Link to="/" className="">
                                <span className="self-center title-text text-2xl md:text-3xl font-semibold whitespace-nowrap text-primary">Auto Hive</span>
                            </Link>
                            <p className='text-gray-300 text-sm md:w-2/3 pt-5'>Brand New and Reconditioned Car Importers & Dealers in Bangladesh. Find complete list of Bangladesh automotive industry.</p>
                        </div>
                        <div className="md:w-1/2 mt-10 md:mt-0 grid grid-cols-2 md:grid-cols-3 gap-y-5 md:gap-0">
                            <div>
                                ...
                                <ul className="text-gray-300 text-sm">
                                    ...
                                    <li>
                                        <a href="/" className="hover:underline">Express.js</a>
                                    </li>
                                    <li>
                            ...
                            <div>
                                ...
                                <ul className="text-gray-300 text-sm">
                                    ...
                                    <li>
                                        <a href="/" className="hover:underline">Stack Overflow</a>
                                    </li>
                                </ul>
                            </div>
                            <div>
                    ...
                    <div className="flex md:flex-row flex-col-reverse items-center justify-between">
                        <p className="text-sm text-gray-500 sm:text-center dark:text-gray-400">Developed By <a href="/" className="hover:underline text-primary">Jummun Islam</a></p>
                        <p className="text-sm mb-1 md:mb-0 text-gray-500 text-center dark:text-gray-400">&copy; {currentYear} <a href="/" className="hover:underline text-primary">Auto Hive™</a>. All Rights Reserved.
                        </p>
