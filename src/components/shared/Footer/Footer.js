...
const Footer = () => {
    ...
    return (
        <div className='bg-[#273036] mt-40'>
            <footer className="pt-10 md:pt-14 pb-5 px-2 xsm:px-0 mx-auto xxl:max-w-screen-xxl xl:max-w-screen-xl lg:max-w-screen-lg md:max-w-screen-md sm:max-w-screen-sm xsm:max-w-screen-xsm">
                <div className="md:flex justify-between">
                    <div className="md:w-1/2">
                        <Link to="/" className="">
                            <span className="self-center title-text text-2xl md:text-3xl font-semibold whitespace-nowrap text-[#88c123]">Auto Hive</span>
                        </Link>
