    ...
    return (
        <div className={openSignInModal ? 'modal-parent-height svg-container' : 'svg-container'}>
            ...
            <div className='relative z-20 top-[40%] md:top-[40%]'>
                <section className="bg-white pt-8 md:pt-32 pb-5 sm:pb-14 mb-32 lg:mb-60">
                    <div className="xxl:max-w-screen-xxl xl:max-w-screen-xl lg:max-w-screen--lg md:max-w-screen-md sm:max-w-screen-sm xsm:max-w-screen-xsm px-2 xsm:px-0 py-12 mx-auto">
                        <div>
                        ...
                        <div className="grid grid-cols-1 gap-12 mt-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                            <div className="p-4 rounded-lg bg-[#87c12330] md:p-6">
                                <span className="inline-block p-3 text-primary rounded-lg bg-lime-100/90">
                                ...
                                <p className="mt-2 text-sm text-secondary">hello@merakiui.com</p>
                            </div>
                            ...
                            <div className="p-4 rounded-lg bg-[#87c12330] md:p-6">
                                ...
                                <p className="mt-2 text-sm text-secondary">100 Smith Street Collingwood VIC 3066 AU</p>
                            </div>
                ...
                <section id='store-location' className="grid justify-around items-center">
                    <div id='overlay'></div>
                    <div className="z-30 xxl:max-w-screen-xxl xl:max-w-screen-xl lg:max-w-screen--lg md:max-w-screen-md sm:max-w-screen-sm xsm:max-w-screen-xsm px-2 xsm:px-0 mx-auto">
                        <div className='grid grid-cols-1 gap-10 py-12 justify-center items-center lg:grid-cols-3'>
                            <div>
                                <p className="font-medium text-blue-500 md:text-3xl">Our locations</p>

                                <h1 className="mt-2 text-2xl font-semibold text-gray-50 md:text-3xl">Visit our stores</h1>

                                <p className="mt-3 text-gray-100">Find us at these locations.</p>
                            </div>
                            <div className="grid grid-cols-1 gap-12 lg:col-span-2 sm:grid-cols-2">
                                <div>
                                    <h2 className="font-medium text-gray-50">Melbourne</h2>
                                    <p className="mt-2 text-gray-400">100 Flinders Street <br /> Melbourne VIC 3000 AU</p>
                                </div>

                                <div>
                                    <h2 className="font-medium text-gray-50">London</h2>
                                    <p className="mt-2 text-gray-400">100 Oxford Street <br /> London W1D 1LL UK</p>
                                </div>

                                <div>
                                    <h2 className="font-medium text-gray-50">Sydney</h2>
                                    <p className="mt-2 text-gray-400">100 Flinders Street <br /> Melbourne VIC 3000 AU</p>
                                </div>

                                <div>
                                    <h2 className="font-medium text-gray-50">San Francisco</h2>
                                    <p className="mt-2 text-gray-400">100 Flinders Street <br /> Melbourne VIC 3000 AU</p>
                                </div>

                                <div>
                                    <h2 className="font-medium text-gray-50">Byron Bay</h2>
                                    <p className="mt-2 text-gray-400">100 Flinders Street <br /> Melbourne VIC 3000 AU</p>
                                </div>

                                <div>
                                    <h2 className="font-medium text-gray-50">Sweden</h2>
                                    <p className="mt-2 text-gray-400">100 Flinders Street <br /> Melbourne VIC 3000 AU</p>
                                </div>
                            </div>
                        </div>
                ...
                <section className="bg-white relative md:py-14 mt-[20%]">
                    <div className="xxl:max-w-screen-xxl xl:max-w-screen-xl lg:max-w-screen--lg md:max-w-screen-md sm:max-w-screen-sm xsm:max-w-screen-xsm px-2 xsm:px-0 mx-auto py-12">
                        <div>
                            <h1 className="mt-2 text-xl font-semibold text-gray-800 md:text-5xl">Get in touch</h1>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2">
                            ...
                            <div className="overflow-hidden rounded-lg h-96 lg:h-auto">
