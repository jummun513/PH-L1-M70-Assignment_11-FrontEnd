...
const CarCart = ({ data, liked, wished }) => {
    return (
        <div id='cart' className='p-3 pb-5 mx-3 xsm:mx-0'>
            ...
            <div className="flex flex-col justify-between">
                ...
                <div className='flex justify-between items-center mt-5'>
                    ...
                    <button type="button" className='btn-style border-2 border-[#88C123] text-white bg-[#88C123] hover:bg-transparent hover:text-[#88C123]'>Buy Now</button>
                </div>
            </div>
        </div>
    );
