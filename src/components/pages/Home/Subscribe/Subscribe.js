                            ...
                            <div className='pt-5 md:p-5'>
                                ...
                                <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-auto sm:flex sm:space-y-0">
                                    <div className="relative w-full">
                                        ...
                                        <input className="block border-none p-3 pl-10 w-full text-sm text-gray-900 bg-gray-50 ring-2 ring-gray-50 focus:ring-primary focus:outline-none" placeholder="Enter your email" type="email" id="subscribe-email" required="" />
                                    </div>
                                    <div>
