                    ...
                    return (
                        <div key={idx} className='flex flex-col justify-center items-center'>
                            ...
                            <div className={slide === idx ? "flex pb-10" : "hidden"}>
                                ...
                                <button type='button' className='btn-style border-2 text-[#88C123] xxl:text-white xxl:border-white border-[#88C123] bg-transparent hover:bg-[#88C123] xxl:hover:bg-white hover:text-white xxl:hover:text-[#88C123]'>Learn More</button>
                            </div>
                            <img loading='lazy'
                                src={item.src}
                                alt={item.alt}
